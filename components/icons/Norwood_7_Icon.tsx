...
const Norwood7Icon: React.FC<IconProps> = ({ className, ...props }) => (
    <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M18 50 C25 30, 40 15, 50 15 C60 15, 75 30, 82 50 L 75 60 L 25 60 Z" stroke="currentColor" strokeWidth="0" fill="#f8fafc" opacity="0.8"/>
        <path d="M25 60 L 18 50 C25 30, 40 15, 50 15 C60 15, 75 30, 82 50 L 75 60" stroke="currentColor" strokeWidth="4" fill="none" strokeLinecap="round"/>
    </svg>
);

export default Norwood7Icon;