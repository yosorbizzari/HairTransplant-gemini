...
const Norwood2Icon: React.FC<IconProps> = ({ className, ...props }) => (
    <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M30 45C30 38 35 30 45 28C55 26 65 30 75 40" stroke="currentColor" strokeWidth="4" fill="none" strokeLinecap="round"/>
        ...
        <rect x="25" y="28" width="50" height="15" fill="#f8fafc" opacity="0.8"/>
        <path d="M25 35C28 32 35 28 45 28C55 28 68 32 75 40" stroke="currentColor" strokeWidth="4" fill="none" strokeLinecap="round"/>
    </svg>
);

export default Norwood2Icon;