...
const Norwood4Icon: React.FC<IconProps> = ({ className, ...props }) => (
    <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M20 55 C25 45, 35 30, 50 30 C65 30, 75 45, 80 55" stroke="currentColor" strokeWidth="0" fill="#f8fafc" opacity="0.8"/>
        <path d="M20 55 C25 45, 35 30, 50 30 C65 30, 75 45, 80 55" stroke="currentColor" strokeWidth="4" fill="none" strokeLinecap="round"/>
        <circle cx="50" cy="20" r="8" fill="#f8fafc" opacity="0.8"/>
        <circle cx="50" cy="20" r="8" stroke="currentColor" strokeWidth="4"/>
    </svg>
);

export default Norwood4Icon;