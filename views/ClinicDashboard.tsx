...
const ClinicDashboard: React.FC<ClinicDashboardProps> = ({ currentUser, clinics, setView, onSaveClinic }) => {
                    ...
                    <div>
                        ...
                        <div className="bg-white p-8 rounded-lg shadow-lg">
                           ...
                           <div className="space-y-4">
                               <p><strong>Tier:</strong> {ownedClinic.tier}</p>
                               ...
                               <p><strong>Status:</strong> {ownedClinic.verified ? 'Verified' : 'Not Verified'}</p>
                           </div>
                           <button 
